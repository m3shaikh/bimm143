...
![](Class14-Mini-Proj.markdown_strict_files/figure-markdown_strict/unnamed-chunk-12-1.png)
...
![](Class14-Mini-Proj.markdown_strict_files/figure-markdown_strict/unnamed-chunk-13-1.png)
...
```
    ...
    Info: Working in directory /Users/maleeha.shaikhh/Desktop/bimm 143/Class 14
...
Uptake and actions of bacterial toxins had the most significant Entities
p-value. Some of the most significant pathways listed matched the
previous KEGG results. Differences between Reactome and KEGG results may
be caused by different variations in databases or statistical methods.
One may be more specific than the other.
