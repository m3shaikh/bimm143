...
![](Class08_MiniProject.markdown_strict_files/figure-markdown_strict/unnamed-chunk-11-1.png)
...
What stands out to me about this plot is how clustered everything is to
each other.
...
![](Class08_MiniProject.markdown_strict_files/figure-markdown_strict/unnamed-chunk-12-1.png)
...
![](Class08_MiniProject.markdown_strict_files/figure-markdown_strict/unnamed-chunk-13-1.png)

I notice that the in this plot, the data is clustred towards the bottom
right whereas in the other plot it was more upward located.
...
concave.points_mean has the strongest loadings on PC1, showing that is
...
![](Class08_MiniProject.markdown_strict_files/figure-markdown_strict/unnamed-chunk-17-1.png)
...
The method that gives my favorite results is the PCA based
visualizations as they give clear results that are easier to interpret.
...
![](Class08_MiniProject.markdown_strict_files/figure-markdown_strict/unnamed-chunk-19-1.png)
...
Hierarchical clustering without PCA is worse in this case.
...
![](Class08_MiniProject.markdown_strict_files/figure-markdown_strict/unnamed-chunk-26-1.png)
